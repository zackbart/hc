...
export const config: SiteConfig = {
  ...
  description: "Christy and I have spent over three decades in full time ministry, and Honest Conversations is where we invite the church to ask the hard questions that many avoid—about justice, power, accountability, and the subtle ways spiritual authority can be misused.",
  author: {
